...
<div class="container-fluid px-4">
    ...
    <div class="mb-4">
        <a href="{{route('presentaciones.create')}}"><button type="button" class="btn btn-primary">Añadir nueva Presentacion</button></a>
    </div>
                           ...
                           <td>
                            ...
                            <div class="modal fade" id="confirmModal-{{$presentacion->id}}" tabindex="-1" aria-labelledby="confirmModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    {{$presentacion->caracteristica->estado==1?'deseas eliminar esta presentacion?': 'deseas restaurar esta presentacion?'}}
                                    </div>
