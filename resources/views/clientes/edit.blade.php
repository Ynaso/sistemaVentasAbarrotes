            ...
            <div class="row g-3">
                <div class="col-md-6 ">
                    ...
                    <select data-size="5" title="Selecciona el tipo de persona" data-live-search="true" name="tipo_persona" id="tipo_persona" class="form-control selectpicker show-tick">
                        <option selected value="{{$cliente->persona->tipo_persona}}">{{"persona ".$cliente->persona->tipo_persona}}</option> 
                    </select>
                ...
                <div class="col-md-12" id="box-razon_social">
                   ...
                   <input tipe="text" name="razon_social" id="razon_social" class="form-control" value="{{old('direccion', $cliente->persona->razon_social)}}"/>
                   @error('razon_social')
