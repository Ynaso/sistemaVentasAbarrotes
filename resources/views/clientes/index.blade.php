                ...
                <tbody>
                    @foreach ($clientes as $cliente)
                        <tr> 
                           ...
                           <td>
                                {{$cliente->persona->Documento->tipo_documento.' '.$cliente->persona->numero_documento}}
                           </td>  
                           ...
                           <td>
                            ...
                            <div class="modal fade" id="confirmModal-{{$cliente->id}}" tabindex="-1" aria-labelledby="confirmModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    {{$cliente->persona->estado==0?'deseas retaurar este cliente?': 'deseas eliminar este cliente?'}}
                                    </div>
